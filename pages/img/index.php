    ...
    <html>
        <head>
            ...
            a { color: #fff; opacity: 1; margin: 0;}
				...
				.titre
				{
					...
					text-shadow: 1px 0.5px 1px rgba(1,0,0,0.5);
					color: #666666;
				}
		#head {
		    height: auto;
		...
		<div id="head">
						<div id="top_bar_head">
							...
							<a href="http://nasa.logipam.org/">	<img src="img/g3969.png" alt="logo" style="margin-left:10%; margin-top:10px; width:145px; height: 100px;float: left;" /></a>
...
<br/>5. NASA administrators have a special status and can login to access a more thorough administrative interface allowing them, not only to execute traditional admin actions (add/remove/edit users) but also to upload files and pertinent information. They will also be able to vet Visitors' comments and tags.
                ...
                <div id="content">
                   <legend> <h1>Our Team</h1></legend>
					...
					<div class="element">
                    <img src="img/logoesih.jpg" alt="Dorleons"/>
                    <h4>Ginel Dorleons</h4>
                      <a>Engineer</a>
                    </div>
				</fieldset>
				<br />
				<fieldset>
                    ...
                    <h4 style="color:#282828;">Patrick Attie</h4>
                      <a style="color:#aaa;">Director General of ESIH</a>	
                    </div>
                    
                    <div class="element">
                    <img src="img/logoesih.jpg" alt="Narcisse"/>
                    <h4 style="color:#282828;">Harold Narcisse</h4>
                      <a style="color:#aaa;">Administrator</a>
                    </div>
                    <div class="element">
                    <img src="img/logoesih.jpg" alt="Sam"/>
                    <h4 style="color:#282828;">Marlene Sam</h4>
